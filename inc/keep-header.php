			                                                    ...
			                                                    <ul class="sub-menu"><?php 
			                                                    	...
			                                                    	if($courseo->rowCount()==0){
																		...
																		$procourse_id = $flow['procourse_id'];
				                                                    		?>
					                                                        <li><a href="application-form/admission-requirements.php?department_name=<?php echo $flow['prog_course'];?>&&identification=<?php echo $procourse_id; ?>"><?php echo $flow['prog_course']; ?></a>
					                                                        </li>
					                                                        <?php
					                                                	} 
					                                                } ?>
