					...
					<div class="row">
						<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
							<div class="tg-widget tg-widgetcompanyinfo">
								<div class="tg-widgetcontent">
									<strong class="tg-logo"><a href="./"><img src="images/logo2.png" alt="image description"></a></strong>
									<div class="tg-description">
										<p align="justify">Moses & Grace College of Health Sciences And Technology is committed to providing high quality education leading to award of Certificate and Diploma in Health Profession. <br />The College strives to produce broadly and thoroughly educated graduates who realize that the health profession is not simply a trade to be learned ... <a href="aboutus.php">Read More</a></p>
									</div>
									...
									<ul class="tg-socialicons">
										...
										<li class="tg-googleplus"><a href="javascript:void(0);"><i class="fa fa-instagram"></i></a></li>
						...
						<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
							<div class="tg-widget tg-widgetcoursecategories">
								...
								<div class="tg-widgetcontent">
									<ul>
										<li><a href="../application-form/select-your-course.php">Community Health Extension Worker</a></li>
                                        <li><a href="../application-form/select-your-course.php">Community Health</a></li>
                                        <li><a href="../application-form/select-your-course.php">Environmental Health Technology</a></li>
                                        <li><a href="../application-form/select-your-course.php">Medical Laboratory Science</a></li>
                                        <li><a href="../application-form/select-your-course.php">Health Information Management</a></li>
                                        <li><a href="../application-form/select-your-course.php">Community Health (Degree)</a></li>
                                        <li><a href="../application-form/select-your-course.php">Nursing Science</a></li>
                                        <li><a href="../application-form/select-your-course.php">Health Information Management</a></li>
									</ul>
								</div>
							</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<span class="tg-copyright">Copyright MOSGRCHT &copy; <?php echo date("Y"); ?> All Rights Reserved</span>
							<nav class="tg-addnav">
								<ul>
