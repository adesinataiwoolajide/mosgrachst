<?php 
    ...
    $detail = $db->prepare("SELECT * FROM student_result WHERE student_matric_num=:student_matric_num AND hod_approval=1 AND bursary_approval=1 AND senate_approval AND session_id=:session_id ORDER BY course_code ASC");
	$ars = array(':student_matric_num'=>$student_matric_num, ':session_id'=>$session_id); 
    $detail->execute($ars); 
    if($detail->rowCount()==0){
    	$_SESSION['error'] = "No Result Was Found For You in $session_id Academic Session"; ?>
    	<script>
							...
							<div id="tg-content" class="tg-content">
								...
								<section class="tg-sectionspace tg-haslayout">
									<div class="tg-borderheading">
										...
										<h5><p align="center" style="color: green"><b><?php echo strtoupper("$surname $other_names This is Your $session_name Academic Result"); ?> </p>
										</h5>
									</div>
									<div class="tg-borderheading">
