					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
							<div class="tg-widget tg-widgetcoursecategories">
								...
								<div class="tg-widgetcontent">
									<ul>
										<li><a href="#">Community Health Extension Worker</a></li>
                                        <li><a href="#">Community Health</a></li>
                                        <li><a href="#">Environmental Health Technology</a></li>
                                        <li><a href="#">Medical Laboratory Science</a></li>
                                        <li><a href="#">Health Information Management</a></li>
                                        <li><a href="#">Community Health (Degree)</a></li>
                                        <li><a href="#">Nursing Science</a></li>
                                        <li><a href="#">Health Information Management</a></li>
									</ul>
								</div>
							</div>
