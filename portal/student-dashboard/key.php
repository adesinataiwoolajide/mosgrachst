                                            ...
                                            if(isset($_POST['search-course'])){
		                                        ...
		                                        if($regid->searchCourse($uppers, $tansform)){
				                                    ...
				                                    <table class="table table-bordered">
		                                                <form action="process-search-course.php" method="post" class="form-control" enctype="multipart/form-data"><?php
		                                                    ...
		                                                    while($wow = $sele->fetch()){
		                                                        ...
		                                                        <tbody>
		                                                            <tr>
		                                                                <td><?php echo $y; ?></td>
		                                                                <td><?php echo $course_code = $wow['course_code'];?>
		                                                                </td>
		                                            ...
		                                            <div align="center">
		                                                ...
		                                                <button type="submit" class="btn btn-primary" name="add-course">REGISTER</button>
