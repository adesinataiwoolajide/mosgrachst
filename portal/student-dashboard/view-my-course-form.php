<?php 
	...
	$myList = $db->prepare("SELECT * FROM course_registration WHERE student_matric_num=:student_matric_num AND session_id=:session_name");
	$arrList = array(':student_matric_num'=>$student_matric_num, ':session_name'=>$session_name);
	$myList->execute($arrList);
	if($myList->rowCount()==0){
		$_SESSION['error'] = "No Registration Was Found For You in $session_name Acedemic Session";?>
		<script>window.location=("see-course-form.php");</script><?php
		    ...
		    <div class="container pt-120 pb-60">
		        <div class="section-content">
		            <div class="row"> 
		                <div class="col-md-12">
		                    <ul class="breadcrumb"> 
		                    	<li><a href="view-my-course-form.php?student_matric_num=<?php echo $student_matric_num?>&&session_name=<?php echo $session_name?>&&session_identification=<?php echo $session_id;?>"><i class="fa fa-list white-text"></i> <?php echo $session_name ?> ACADEMIC COURSE FORM</a></li>
							...
							<div id="tg-content" class="tg-content">
								...
								<section class="tg-sectionspace tg-haslayout">
									<div class="tg-borderheading">
										<h3><p align="center" style="color: green;">STUDENT ACADEMIC SESSION FORM </p></h3>
										<h5><p align="center" style="color: green;"><?php echo $surname. " ". $other_names; ?> PLEASE PREVIEW YOUR COURSE FORM BELOW</p></h5>
									</div>
									<div class="tg-borderheading">
					                    ...
					                    <div class="tg-addmission tg-addmissiondetail">
											...
											<div class="tg-container">
												...
												<div class="col-md-6" align="left">
			                                        <h6><B><p>Matric Number: <?php echo $_SESSION['user_name']; ?></p>
												...
												<table class="table table-responsive table-bordered">
													...
													while($now = $myList->fetch()){ ?>
														...
														<tbody>
															...
															$see->execute($seeArr);
															$sis = $see->fetch() ?>
															<td><?php echo $sis['course_title']; ?></td>
															<td><?php echo $sis['course_status']; ?></td>
															<td><?php echo $course_unit = $sis['course_unit']; ?></td>
															<td>
									                            <a href="remove-my-course.php?student_matric_num=<?php echo $student_matric_num; ?>&& registration-identification=<?php echo $now['registration_id']; ?>&&session_identification=<?php echo $session_id; ?>" class="btn btn-danger" onclick="confirmToDelete()"><i class="glyphicon glyphicon-trash"></i>
									                            Remove Course</a>
									                        </td>
									...
									<div class="col-sm-12" align="center">
		                                <div class="md-form-group">
		                                    ...
		                                    <a href="printing-my-course-form.php?student-matric-number=<?php echo $student_matric_num?>&&session_identification=<?php echo $session_name?>" class="btn btn-success" target="_blank"><i class="fa fa-print"></i> PRINT MY COURSE FORM</a>
