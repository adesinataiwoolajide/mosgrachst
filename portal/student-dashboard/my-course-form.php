    ...
    <div class="container pt-120 pb-60">
        <div class="section-content">
            <div class="row"> 
                <div class="col-md-12">
                    <ul class="breadcrumb"> 
                    	<li><a href="my-course-form.php?student-matric-number=<?php echo $student_matric_num?>&&session_identification=<?php echo $session_id; ?>"><i class="fa fa-book white-text"></i> MY COURSE FORM</a></li>
					...
					<div id="tg-content" class="tg-content">
						...
						<section class="tg-sectionspace tg-haslayout">
							<div class="tg-borderheading">
								<h3><p align="center" style="color: green;">STUDENT COURSE FROM</p></h3>
									<h5><p align="center" style="color: green;"><?php echo $surname. " ". $other_names; ?> PLEASE PREVIEW YOUR COURSE FORM <?php echo $session_id ?> ACADEMIC SESSION BELOW</p>
									</h5>
							</div>
							<div class="tg-borderheading">
							...
							<div class="col-sm-12" align="center">
                                <div class="md-form-group">
                                    ...
                                    <a href="printing-my-course-form.php?student-matric-number=<?php echo $student_matric_num?>&&session_identification=<?php echo $depo['session_id']; ?>" class="btn btn-success" target="_blank"> PRINT MY COURSE FORM
