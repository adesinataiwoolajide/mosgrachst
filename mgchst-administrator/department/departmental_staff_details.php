...
<ul class="breadcrumb">
    <li><a href="./">Home</a></li>                    
    <li><a href="view-departmental-lecturers.php">Departmental Lecturers</a></li> 
    <li><a href="departmental_staff_details.php?staff_number=<?php echo $staff_number;?>&&staff_email=<?php echo $staff_email;?>"><?php echo $details['staff_name']; ?></a>Details</li>
    <li class="active"></li>   
</ul>
<!-- END BREADCRUMB -->                       
<?php
        ...
        <div class="col-md-3">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body list-group border-bottom">
                    ...
                    <!-- <a href="" class="list-group-item"><span class="fa fa-coffee"></span> Schedule <span class="badge badge-default">18</span></a>                                
                    <a href="" class="list-group-item"><span class="fa fa-users"></span> Customer <span class="badge badge-danger">+7</span></a> -->
                    <a href="" class="list-group-item"><span class="fa fa-folder"></span> Activities</a>
                    <a href="" class="list-group-item"><span class="fa fa-cog"></span> Chat</a>
                </div>
                    ...
                    <div class="panel-body">
                    	<table id="customers2" class="table datatable">
                    		...
                    		<tbody>
                    			<tr>
                    				<td>Department</td>
                    				<td><?php  $dept_id = $details['dept_id']; $dept_id = $details['dept_id'];
                                	$oya =$department->getDepartmentDetails($dept_id); echo $oya['dept_name']; ?></td>	
                    			</tr>
                    		</tbody>
                    		<tbody>
                    			<tr>
