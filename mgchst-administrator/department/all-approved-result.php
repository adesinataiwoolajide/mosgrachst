<?php
	...
	$detail = $db->prepare("SELECT * FROM student_result WHERE hod_approval=1 AND bursary_approval=1 AND senate_approval=1 AND dept_id=:dept_name ORDER BY session_id ASC");
    	...
    	<div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><p style="color: red" align="center">No Result Have Been Approved From <?php echo $dept_name ?>  Department</p></h3>
                </div>
            </div>
        </div><?php
    }else{ ?>
