<?php
	...
	$detail = $db->prepare("SELECT * FROM student_result WHERE senate_approval=1 AND dept_id=:dept_name ORDER BY session_id ASC");
    	...
    	<div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><p style="color: red" align="center">The School Senate Have Not Approved Any Result From <?php echo $dept_name ?>  Department</p></h3>
                </div>
            </div>
        </div><?php
    }else{ 
