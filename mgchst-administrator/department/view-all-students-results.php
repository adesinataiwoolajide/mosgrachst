<?php
    ...
    $detail = $db->prepare("SELECT * FROM student_result WHERE dept_id=:dept_name ORDER BY session_id DESC");
	        ...
	        <div class="col-md-12"> <?php
	           ...
	           <div class="panel panel-default">
	                <div class="panel-heading">
	           			<p style="color: red" align="center">No Result Found For <?php echo $dept_name ?><a></p>
	           		</div>
	           	</div><?php
	            }else{ ?>
	                <div class="panel panel-default">
