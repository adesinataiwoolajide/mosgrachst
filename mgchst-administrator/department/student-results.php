	        ...
	        <div class="col-md-12"> <?php
	           ...
	           <div class="panel panel-default">
	                <div class="panel-heading">
	           			<p style="color: red" align="center">No Result Found for <?php echo $title ?> in <?php $session_id ?>  Academic Session  Please Click 
	           				<a href="our-departmental-courses.php" class="btn btn-warning"> on this to return to the previous Page</a></p>
	           		</div>
	           	</div><?php
	            }else{ ?>
	                <div class="panel panel-default">
