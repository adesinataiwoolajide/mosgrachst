    ...
    <div class="row">
        <div class="col-md-12"> 
            <div class="panel panel-default"><?php
                ...
                $query = $db->prepare("SELECT * FROM departmental_courses WHERE dept_id=:dept_id");
                $arr = array(':dept_id'=>$dept_id);
                $query->execute($arr);   
                if($query->rowCount()==0){ ?>
                    <h3><p align="center" style="color: red"><?php echo $dept_name ?> Departmental Course List is Empty<br>Please Click on Add Course to Add A New Course to the Departmental List</p></h3><?php
                }else{ ?>
