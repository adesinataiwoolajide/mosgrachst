        ...
        <div class="col-md-12"> 
            <div class="panel panel-default">
                ...
                <div class="panel-body"><?php
                    ...
                    $sepp->execute($arrSep);   
                    if($sepp->rowCount()==0){ ?>
                        <h3><p align="center" style="color: red">No Course is Available for <?php echo "dept_name at the moment, Please Contact The MIS to Add Courses To Your Departmental Courses" ?>.<br></p></h3><?php
                    }else{ ?>
