    ...
    <div class="page-content-wrap">                 
        <div class="row">
            <div class="panel panel-default">
                ...
                <div class="col-md-4">
                    <div class="widget widget-default widget-item-icon" onclick="location.href='our-departmental-courses.php';">
                        <div align="center">
                ...
                <div class="col-md-4">
                    <div class="widget widget-default widget-item-icon" onclick="location.href='approve-result.php';">
                        <div align="center">
