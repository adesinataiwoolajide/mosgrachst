<?php
	...
	$detail = $db->prepare("SELECT * FROM student_result WHERE bursary_approval=1 AND dept_id=:dept_name ORDER BY session_id ASC");
    ...
    <ul class="breadcrumb">
       <ul class="breadcrumb">
            ...
            <li class="active"> Senate Approved Students Results</li>    
        </ul> 
    </ul><?php
    	...
    	<div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><p style="color: red" align="center">Bursery Have Not Approved Any Students Results From <?php echo $dept_name ?>  Department</p></h3>
                </div>
            </div>
        </div><?php
    }else{ ?>
