<?php
	...
	$detail = $db->prepare("SELECT * FROM student_result WHERE hod_approval=1 AND bursary_approval=1 AND senate_approval=1  ORDER BY session_id ASC");
	$detail->execute(); ?>
    <ul class="breadcrumb">
       <ul class="breadcrumb">
            <li><a href="./">Home</a></li>                    
    	...
    	<div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><p style="color: red" align="center">No Result Have Been Approved</p></h3>
                </div>
            </div>
        </div><?php
    }else{ ?>
