     ...
     ?>
		<ul class="breadcrumb">
		   <ul class="breadcrumb">
		        ...
		        <li><a href="compute-multiple-result.php?course_code=<?php echo $course_code ?>&&session_identification=<?php echo $session_id; ?>&&department=<?php echo $dept_id; ?>">Compute Result</a></li> 
			            ...
			            <div class="col-md-12"> 
			                <div class="panel panel-default">
			                    ...
			                    <div class="panel-body">
			                        <form action="process-multiple-student-result.php" method="post" class="form-horizontal" enctype="multipart/form-data">
