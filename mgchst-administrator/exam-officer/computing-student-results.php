    ...
    <div class="row">
        <div class="col-md-12"> 
            <div class="panel panel-default"><?php
                ...
                $query = $db->prepare("SELECT * FROM course_allocation ORDER BY course_code ASC");
                $query->execute();   
                if($query->rowCount()==0){ ?>
                            ...
                            while($vope=$query->fetch()){  
                               ...
                               // $foll = $course->getCourseIdentity($course_id);?>
                                <tr>
                                    ...
                                    $joy = $sess->fetch(); ?>
                                    <td>
                                        <a href="compute-multiple-result.php?course_code=<?php echo $course_code ?>&&session_identification=<?php echo $joy['session_name']; ?>&&department=<?php echo $dept_name; ?>" class="btn btn-success">Compute Result
                                        </a> <br>
