...
?>
    ...
    <div class="page-content-wrap">                 
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="widget widget-default widget-item-icon" onclick="location.href='computing-student-results.php';">
                    <div align="center">
            ...
            <div class="col-md-3">
                <div class="widget widget-default widget-item-icon" onclick="location.href='all-approved-result.php';">
                    <div align="center">
                        <img src="../icons/images.jpg" style="width: 100px; height: 100px;" align="center"><p align="center">Approved Results</p>
                    </div>         
                </div>                            
            </div>
            <div class="col-md-3">
