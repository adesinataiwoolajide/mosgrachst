...
<ul class="breadcrumb">
   <ul class="breadcrumb">
        ...
        <li class="active">View My Courses</li>    
    </ul> 
</ul>
<!-- END BREADCRUMB -->                       
<?php
	...
	<div class="row">
        <div class="col-md-12"> 
            <div class="panel panel-default"><?php
                ...
                $query->execute($arr);   
                if($query->rowCount()==0){ ?>
                    <h3><p align="center" style="color: red">No Courses Have Been Allocated To You From Your Department <?php echo $dept_name ?> </p></h3><?php
                }else{ ?>
