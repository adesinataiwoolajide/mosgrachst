...
<ul class="breadcrumb">
    <li><a href="./">Home</a></li>                    
    <li><a href="all-students-details.php"><?php echo "$dept_name Students List" ?></a></li>   
    ...
    <div class="panel panel-default">
        ...
        if($stu->rowCount()==0){ ?>
            <div class="panel panel-default">
                <div class="panel-heading">
                     <p style="color: red;" align="center">There are No Students in Your Department<?php echo $school_name  ?> Is List is Empty.</p>
                </div>
            </div>
           <?php
        }else{ ?>
        ...
        <div class="row">
            <div class="col-md-12"> 
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><?php echo " The List of All $dept_name Students List" ?></h3>
