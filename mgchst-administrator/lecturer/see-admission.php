...
<ul class="breadcrumb">
    <li><a href="./">Home</a></li>   
    <li><a href="see-admission.php">View Admission By Category</p></a></li>         
    <li class="active">View Admission By School</li>   
</ul>
<!-- END BREADCRUMB -->                       
<?php
	...
	<div class="row">
        <div class="col-md-12"> 
            <div class="panel panel-default">
                ...
                $admit->execute();
                if($admit->rowCount()<1){ ?>
                    <p align="center" style="color: red">No Student Have Been Admitted Into <?php echo $dept_name ?>.<br> Please Click on Admit Students to Admit New Students</p><?php
                }else{ ?>
