...
<div class="page-content-wrap">
	<div class="row">
        <div class="col-md-12"> <?php 
            $admit = $db->prepare("SELECT * FROM admission_payment WHERE payment_status=0 ORDER BY pay_id ASC");
            $admit->execute();
            if($admit->rowCount()<1){ ?>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form action="process-confirmed-payments.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                                    ...
                                    while($see = $admit->fetch()){
                                       ...
                                       // $details = $admin->getingIdentification($procourse_id);
                                        ...
                                        <tr>
                                            ...
                                            <input type="hidden" name="student_email<?php echo $y; ?>" value="<?php echo $ema; ?>">
                            ...
                            <div class="col-sm-12" align="center">
                                <div class="md-form-group">
                                    ...
                                    <button type="submit" class="btn btn-success">CONFIRM PAYMENTS</button>
                                </div>
                            </div>
                        <form>
                    </div>
