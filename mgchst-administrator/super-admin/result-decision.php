    ...
    <div class="page-content-wrap">                 
        <div class="row">
            <div class="panel panel-default">
                ...
                <div class="col-md-4">
                    <div class="widget widget-default widget-item-icon" onclick="location.href='result-panel.php';">
                        <div align="center">
                            ...
                            <p align="center">Approve Result</p>
                        </div> 
                        <p style="color: green" align="center">Please Click to Approve Students Results</p>        
                    </div>                            
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="widget widget-default widget-item-icon" onclick="location.href='view-all-students-approved-results.php';">
                        <div align="center">
                            <img src="../icons/teac.jpg" style="width: 100px; height: 100px;" align="center">                    
                            <p align="center">Approved Students Results</p>
                        </div> 
                        <p style="color: green" align="center">Please Click to View Approved Students Results</p>             
                    </div>                            
                </div>
            </div>
        </div> 
