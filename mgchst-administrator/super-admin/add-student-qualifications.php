...
<ul class="breadcrumb">
    <li><a href="./">Home</a></li>                    
    <li><a href="add-students">Add Student</a></li>  
    <li><a href=" add-student-qualifications.php?student_matric_num=<?php echo $student_matric_num ?>&&registration_number=<?php echo $regNumber ?>&&school_name=<?php echo $school_name ?>&&school_identification=-<?php echo $school_id ?>">Add Student Qualifications </a></li>  
            ...
            <form action="process-add-student-qualifications.php" method="post" class="form-horizontal" enctype="multipart/form-data">
	            <div class="panel panel-default">
	                <div class="panel-heading">
	                    <h3 class="panel-title"><strong>Add The </strong> Student Educational Qualification</h3>
                    ...
                    if($school_id ==1){ ?>
                        ...
                        <div class="panel-body">
                            <h3><p style="color: green;" align="center">Please fill the below form to Add The Student Qualification</p></h3>
                            <h4 style="color: green; text-align: center">SECTION TWO (STUDENT QUALIFICATION).</h5>
                        ...
                        <div class="panel-body">
                            <h3><p style="color: green;" align="center">Please fill the below form to Add The Student Qualification</p></h3>
                            <h4 style="color: green; text-align: center">SECTION TWO (STUDENT DEQUALIFICATION).</h5>
