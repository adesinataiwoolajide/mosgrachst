                            ...
                            <tbody><?php
                                ...
                                while($new = $stu->fetch()){ 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="edit-matric-number.php?registration_number=<?php echo $regNumber; ?>" class="btn btn-warning pull-left"onclick=""><i class="glyphicon glyphicon-pencil"></i>Edit Matric Number
                                            </a><br><br>
                                            <a href="student-details.php?student_matric_num=<?php echo $student_matric_num;?>&&register_number=<?php echo $regNumber; ?>" class="btn btn-success pull-left"onclick=""><i class="glyphicon glyphicon-user"></i>View More Details
                                            </a>
