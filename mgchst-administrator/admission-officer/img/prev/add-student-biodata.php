            ...
            <form action="process-add-student-biodata.php" method="post" class="form-horizontal" enctype="multipart/form-data">
	            <div class="panel panel-default">
	                ...
	                <div class="panel-body">
	                    <p style="color: green;" align="center">Please fill the below form to Add a New Student Details</p>
	                    <h3 style="color: green; text-align: center">SECTION ONE (STUDENT DETAILS AND NEXT OF KIN DETAILS).</h3>
	                    <h4 align="center"><strong>1. STEP ONE A (STUDENT DETAILS).</strong></h4>
	                ...
	                <div class="panel-body form-group-separated"> 
	                	...
	                	<div class="form-group col-md-12">
	                        ...
	                        <div class="col-md-5 col-xs-6">
	                        	<div class="input-group">
	                                <span class="input-group-addon"><span class="fa fa-user"></span></span><?php
	                                $early = 2000;
	                                $current = date("Y");
	                                print '<select class ="form-control" required name ="year_admit">';?>
	                                <option>-- Please Select The Admission Year --</option>
