...
<ul class="breadcrumb">
    ...
    <li><a href="preview-student-details.php?reg_number=<?php echo $regNumber ?>">
								...
								<table class="table table-responsive table-bordered" style="width: 920px">
		                            ...
		                            <tbody>
		                                <tr>
		                                    ...
		                                    <td class="center"><input type="number" class="form-control" required name="from_date1" value="<?php echo $details2['from_date1'] ?>"></td>

		                                    <td class="center"><input type="number" class="form-control" required name="to_date1" value="<?php echo $details2['to_date1'] ?>"></td>
		                                ...
		                                <tr >
		                                    ...
		                                    <td class="center" >
		                                    	<input type="number" class="form-control" name="from_date2" value="<?php echo $details2['from_date2'] ?>" required></td>
		                                    <td class="center">
		                                    	<input type="number" class="form-control" value="<?php echo $details2['to_date2'] ?>" required name="to_date2"></td>
		                                ...
		                                <tr >
		                                    ...
		                                    <td class="center">
		                                    	<input type="number" class="form-control" name="from_date3" value="<?php echo $details2['from_date3'] ?>"></td>
		                                    <td class="center">
		                                    	<input type="number" class="form-control" name="to_date3" value="<?php echo $details2['to_date3'] ?>"></td>
		                                    <td class="center">
		                                ...
		                                <tr >
		                                    ...
		                                    <td class="center"><input type="number" class="form-control" name="from_date4" value="<?php echo $details2['from_date4'] ?>"></td>
		                                    <td class="center"><input type="number" class="form-control" name="to_date4" value="<?php echo $details2['to_date4'] ?>"></td>
		                                ...
		                                <tr >
		                                    ...
		                                    <td class="center"><input type="number" class="form-control" name="fromdate5" value="<?php echo $details2['from_date5']; ?>"></td>
		                                    <td class="center"><input type="number" class="form-control" name="todate5" value="<?php echo $details2['to_date5'] ?>"></td>
