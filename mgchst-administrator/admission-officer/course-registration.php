        ...
        <div class="col-md-12"> 
            <div class="panel panel-default">
                ...
                <div class="panel-body"><?php
                    $sepp = $db->prepare("SELECT * FROM school_course ORDER BY course_title ASC");
                    $sepp->execute();   
                    if($sepp->rowCount()==0){ ?>
                        <h3><p align="center" style="color: red">The School Course List is Empty.<br></p></h3><?php
                    }else{ ?>
                                ...
                                <tbody> 
                                    ...
                                    while($vope=$sepp->fetch()){  
                                        ...
                                        <tr>
                                            ...
                                            <input type="hidden" name="dept_name" value="<?php echo $dept_id ?>">
