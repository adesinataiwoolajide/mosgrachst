            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div class="col-md-12">
                        ...
                        <form action="process-search-course.php" method="post" enctype="multipart/form-data">
                            <div class="col-md-8">
                                <label>Course Code/Course Title</label>
                                <input type="text" name="course_code" class="form-control" required placeholder="Please Enter The Course Code/Course Title To Search For a Course">
                                <input type="hidden" name="student_matric_num" value="<?php echo $student_matric_num ?>">
                                <input type="hidden" name="dept_id" value="<?php echo $dept_name ?>">
                            ...
                            <div class="col-md-4">
                                <button type="submit" name="adding_course" class="btn btn-success">SEARCH FOR COURSE</button>
                            </div>
                        </form>
                    </div>
